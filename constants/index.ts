...
export const navigationData = [
...

  {
    ...
    subNavs: [
      ...
      {
        label: 'Tuition & Financial Planning',
        url: '/plan'
      },
      {
        label: 'Meet Our Student Ambassadors',
        url: '/plan'
      },
      {
        label: 'Viewbook',
      ...
      {
        label: 'Meet Our Admissions Team',
        url: '/plan'
      },
